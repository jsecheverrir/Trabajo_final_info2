    ...
    ui(new Ui::MainWindow)
{
    ...
    QPixmap backgroundImage("C:/Users/juana/OneDrive/Escritorio/trabajo final info 2/final/fotos/level/nivel1.jpg");
    ...
    if (backgroundImage.isNull()) {
        ...
        for (int i = 0; i < numHearts; ++i) {
            QPixmap heartImage("C:/Users/juana/OneDrive/Escritorio/trabajo final info 2/final/fotos/sprite/heart.png");
        ...
        int i=0;
        QPixmap scoreimage("C:/Users/juana/OneDrive\Escritorio/trabajo final info 2/final/fotos/sprite/score.png");
