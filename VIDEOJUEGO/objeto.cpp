...
OBJETO::OBJETO(QGraphicsScene *scene, Personaje *shooter, const QPointF &direction, int speed)
    : scene(scene), shooter(shooter), direction(direction), speed(speed)
{
    ...
    setPixmap(QPixmap("C:/Users/maria/OneDrive/Documentos/INFO2-REPOSITORIO/Proyecto-Final/Trabajo_final_info2/NIVEL3/fotos/sprite/bala.png"));
