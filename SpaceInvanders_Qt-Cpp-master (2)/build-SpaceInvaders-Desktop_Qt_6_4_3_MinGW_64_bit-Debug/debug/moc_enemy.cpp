...
Q_CONSTINIT static const qt_meta_stringdata_Enemy_t qt_meta_stringdata_Enemy = {
    {
        ...
        QT_MOC_LITERAL(6, 15),  // "deadIsActivated"
        QT_MOC_LITERAL(22, 0),  // ""
        QT_MOC_LITERAL(23, 12)   // "updatePixmap"
    },
    "Enemy",
    "deadIsActivated",
    "",
...
void Enemy::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Enemy::*)();
            if (_t _q_method = &Enemy::deadIsActivated; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
